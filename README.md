...
Select `dandyarise/context-bridge-external` in the model picker, then open the chat configuration
...
Enable `dandyarise/context-bridge` as an integration and configure the same endpoint, model ID, and
